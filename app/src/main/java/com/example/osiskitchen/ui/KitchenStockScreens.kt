            ...
            Column(
                ...
                LazyColumn(
                    ...
                    items(filtered) { plato ->
                        val available = plato.erabilgarri.equals("Bai", ignoreCase = true)
                        val containerColor =
                            if (!available) {
                        ...
                        Card(
                            ...
                            Row(
                                ...
                                Column(horizontalAlignment = Alignment.End) {
                                    Text(
                                        text = if (available) "Aktibo" else "Ez aktibo",
                                        style = MaterialTheme.typography.bodyMedium,
                                        color = MaterialTheme.colorScheme.onSurfaceVariant
                                    )
                                    Spacer(modifier = Modifier.height(4.dp))
                                    Text(
                                        text = plato.prestatuDaitezkeenUnitateak.toString(),
                        ...
                        Card(
                            ...
                            Row(
                                ...
                                Column(modifier = Modifier.weight(1f)) {
                                    ...
                                    Text(
                                        text = buildString {
                                            append("Gutx: ${ingrediente.gutxienekoStock}")
                                            if (!ingrediente.neurriaUnitatea.isNullOrBlank()) {
                                                append(" · ${ingrediente.neurriaUnitatea}")
                                            }
                                        },
                                        style = MaterialTheme.typography.bodyMedium,
                                        color = MaterialTheme.colorScheme.onSurfaceVariant
                                ...
                                Text(
                                    ...
                                    style = MaterialTheme.typography.titleMedium,
                                    modifier =
                                        Modifier.width(56.dp).clickable(enabled = !isUpdating) {
